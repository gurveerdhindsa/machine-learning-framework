...
public class AbsoluteDistanceTest {
	...
	public void setUp() throws Exception {
		...
		this.value3 = new DoubleFeature(10.0, this.metric);
		this.value4 = new DoubleFeature(5.0, this.metric);
	...
	public void testcalculateDoubleFeature() {
		...
		assertEquals(this.metric.calculate(value3, value4), 5);
	}
	@Test
